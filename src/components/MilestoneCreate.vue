    ...
    <div class="column is-4-desktop is-3-widescreen">
      <div class="content main-box has-background-white slideIn">
        <form class="form" @submit.prevent="submit">
          <h1>Nuevos objetivos para <span v-html="data.title"></span></h1>
          <p>Ingresá la lista de objetivos separadas por salto de línea</p>
          <div class="field">
            <div class="control">
              <textarea v-model="data.milestones" class="textarea" placeholder="Primer Objetivo 
Segundo objetivo
etc..." required></textarea>
          ...
          <div class="field">
            <div class="control has-text-centered">
              <button type="submit" class="button is-link is-medium" :class="{'is-loading' : $root.processing}">Establecer objetivos</button>
            </div>
          </div>  
        </form>
      </div>
